...
l = [16, 14, 27, -9, 9, 15, 122, 64]
nl= []
for i in range(len(l)):
    if l[i] > 0 and math.sqrt(l[i]) == int(math.sqrt(l[i])):
        nl.append(int(math.sqrt(l[i])))
print(nl)
...
day = {'01': 'первое', '02': 'второе', '03': 'третье', '04': 'четвертое', '05': 'пятое',
       ...
       '31': 'тридцать первое'}
l = (datetime.date(15, 7, 2019))
s = day[l[0]] + day[l[3]] + day[l[5]]
print(s)
#  for l in l.key:
#   print(day(l[0][0:2]), date_setting(l[0][2:5]),(l[0][6:10], 'года'))
